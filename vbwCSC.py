...
class block(_object):
    ...
    if _newclass:
        dataType = _swig_property(_vbwCSC.block_dataType_get, _vbwCSC.block_dataType_set)
...
def run_vbw(again, k, mdfile, N, n, Ncurves, presaxsfile, saxsfile, precsfile, rmscsfile, csfile, outfile, nprocs, w_cut, data_type):
    return _vbwCSC.run_vbw(again, k, mdfile, N, n, Ncurves, presaxsfile, saxsfile, precsfile, rmscsfile, csfile, outfile, nprocs, w_cut, data_type)
