...
class block(_object):
    ...
    if _newclass:saxsWeightsEns = _swig_property(_vbw.block_saxsWeightsEns_get, _vbw.block_saxsWeightsEns_set)
    __swig_setmethods__["wCurrent"] = _vbw.block_wCurrent_set
    __swig_getmethods__["wCurrent"] = _vbw.block_wCurrent_get
    if _newclass:wCurrent = _swig_property(_vbw.block_wCurrent_get, _vbw.block_wCurrent_set)
    __swig_setmethods__["wCurrentPrim"] = _vbw.block_wCurrentPrim_set
    __swig_getmethods__["wCurrentPrim"] = _vbw.block_wCurrentPrim_get
    if _newclass:wCurrentPrim = _swig_property(_vbw.block_wCurrentPrim_get, _vbw.block_wCurrentPrim_set)
    __swig_setmethods__["alphaL"] = _vbw.block_alphaL_set
    __swig_getmethods__["alphaL"] = _vbw.block_alphaL_get
    if _newclass:alphaL = _swig_property(_vbw.block_alphaL_get, _vbw.block_alphaL_set)
    def __init__(self): 
        this = _vbw.new_block()
